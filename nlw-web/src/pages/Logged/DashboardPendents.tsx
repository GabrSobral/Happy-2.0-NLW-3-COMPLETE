...
import { FiPower, FiMapPin, FiAlertCircle, FiArrowRight, FiArrowLeft, FiSearch, FiUserPlus, FiUser} from 'react-icons/fi'
            ...
            <div id="dashboard">
                <aside className='app-sidebar'>
                    ...
                    <div className='registrations'>
                        ...
                        <Link to='/dashboard/pendents' className='registrations-button active'>
